            ...
            <div class="banner-content banner-left animate">
                <div class="banner-title">
                    <h1 class="section-title wow fadeInUp" style="visibility: visible;">
                        ...
                        <span class="banner-text wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s;">We create fantastic and attractive residential designs that have integrated fine architecture with potential customer’s comfort in mind executed flawlessly by top architects in bangalore.</span>
                    </h1>
                </div>
