 ...
 .banner_bg{    background-color: rgb(59 59 59 / 50%);position:relative;
  background-image:url(public/assets/images/architects/best-architects-in-hosur.png);background-position:left;background-size:cover;padding:140px 0 165px;margin-top:65px}.banner_bg{padding:120px 0 90px}.banner-content{width:56%}.banner_img{position:relative;right:0;top:0}.banner-title .section-title{font-family:sofia_probold;font-size:51px;line-height:65px;color:#ffc30e;margin:0}.banner-title p{padding-bottom:10px;color:#fff;font-family:sofia_prolight;font-weight:300;font-size:50px;line-height:65px;color:#fff}.banner-title .section-title .in{line-height:50px;color:#fff;font-family:sofia_probold;display:block;font-size:18px;position:relative;margin-bottom:10px;padding-top:40px!important;text-transform:uppercase}.banner-title .section-subtitle{color:#fff}.banner-list li{color:#fff}.banner-list li:before{background:#fff}.banner-title .in b{color:#ffc30e}.banner-title .section-title .in{padding-top:10px!important}.banner-text{color:#fff;text-transform:none;font-size:17px;line-height:30px;padding:40px 0;width:75%;font-family: sofia_prolight;position:relative;display:block}.banner-text:before{width:65px}.banner-text:before{content:"";width:60px;height:2px;background:#fff;display:block;position:absolute;top:10px;left:0;right:0;margin:0}@media only screen and (max-width:768px){.section_container.white-bg{margin-top:0}.banner-continer,.banner_bg{padding:35px 0;margin-top:120px}.banner-title .section-subtitle{line-height:normal}.banner-text:before{margin:0 auto}.banner-text{width:100%;font-size:14px;padding:30px 0}.banner-title .section-title{font-size:31px;line-height:40px}.banner-content{width:100%;text-align:center}.banner-title p{font-size:31px!important;line-height:40px}.gallery-wrapper ul li span{font-size:18px}}@media only screen and (max-width:641px){.banner_bg{padding:0;background-position:center;margin-top:120px}.banner-title .section-title{font-size:28px}.banner-title p{font-size:24px}.banner-title .section-subtitle{font-size:26px;margin-bottom:10px}.banner-text{padding:30px 0 30px;font-size:18px}.banner-title .section-title span{font-size:16px!important;line-height:26px;width:100%!important}section.banner_bg:after{content:"";position:absolute;width:100%;height:100%;background:#00000080;top:0;left:0;bottom:0;right:0}.banner-title .section-title .in{padding-top:0!important;font-size:14px!important;line-height:24px}}
   ...
   <div class="body-container">
         ...
         <div class="container">
            <div class="flex-col-container">
                         <div class="flex-col-left">
                           <img loading="lazy" width="613" height="453" class="transactional-img customwid" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="public/assets/images/homepage/construction-services.png" alt="Residential Construction Services" title="Residential Construction Services" style="">
                        </div>
               ...
               <h4 class="section-subtitle wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s;max-width:900px;">From Concept to Creation We Cover The Shortest Distance Between Paradise & Place Called “Home”</h4>
                 ...
                 <div class="flex-col-container reverse">
                        ...
                        <div class="flex-col-left mlauto">
                           <img loading="lazy" width="613" height="518" class="advertising-img " src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="public/assets/images/homepage/architectural-design-services.webp" alt="Architectural Design Services" title="Architectural Design Services" style="">
                        </div>
                     </div>
                     <div class="flex-col-container">
                         <div class="flex-col-left">
                           <img loading="lazy" width="613" height="518" class="transactional-img customwid LoadImg" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="public/assets/images/homepage/home-interior-decorators.png" alt="Home Interior Designers" title="Home Interior Designers" style="">
                        </div>
                        <div class="flex-col-right contentL">
                           <div class="flex-head wow fadeInUp" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s;">
                     ...
                     <div class="flex-col-container reverse">
                        ...
                        <div class="flex-col-left mlauto">
                           <img loading="lazy" class="advertising-img " width="613" height="518" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="public/assets/images/homepage/building-construction-contractors.png" alt="House Construction Contractors" title="House Construction Contractors" style="">
                        </div>
                     </div>
                     <div class="flex-col-container">
                         <div class="flex-col-left">
      ...
      <section class="section_container middle-cta" data-src="public/assets/images/mid-bg.webp"  style="background-image: url(public/assets/images/mid-bg.webp);">
         <div class="">
      ...
      <section class="section_container clearfix multifaceted">
         <div class="container">
            ...
            <div class="gallery-wrapper">
               <ul>
                  <li>
                     <img width="380" height="200" loading="lazy" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="public/assets/images/homepage/one-stop-solution.png" alt="One Stop Solution" title="One Stop Solution">
                     <span>One Stop Solution</span>
                  </li>
                  <li>
                     <img width="380" height="200" loading="lazy" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="public/assets/images/homepage/superior-design.png" alt="Superior Design" title="Superior Design">
                     <span>Superior Design</span>
                  </li>
                  <li>
                     <img width="380" height="200" loading="lazy" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="public/assets/images/homepage/on-time-delivery.png" alt="On Time Delivery" title="On Time Delivery">
                     <span>On-time Delivery</span>
                  </li>
                  <li>
                     <img width="380" height="200" loading="lazy" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="public/assets/images/homepage/homes-with-warranty.png" alt="Homes With Warranty" title='Homes With Warranty'>
                     <span>Homes with Warranty</span>
                  </li>
                  <li>
                     <img width="380" height="200" loading="lazy" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="public/assets/images/homepage/quality.png" alt="Quality" title="Quality">
                     <span>Quality</span>
                  </li>
                  <li>
         ...
         <div class="container">
               ...
               <div id="upload-content1" class="active target-div">
                     <ul class="owl-carousel">
                        ...
                        <img loading="lazy" width="382" height="298"  src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="public/assets/images/gallery/gallery-1.png" alt="">
                        </li>
                        <li class="item" style="width:250px">
                        <img loading="lazy" width="382" height="298" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="public/assets/images/gallery/gallery-2.png" alt="">
                        </li>
                        <li class="item" style="width:250px">
                        <img loading="lazy" width="382" height="298" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="public/assets/images/gallery/gallery-3.png" alt="">
                        </li>
                        <li class="item" style="width:250px">
                        <img loading="lazy" width="382" height="298" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="public/assets/images/gallery/gallery-4.png" alt="">
                        </li>

                        <li class="item" style="width:250px">
                        <img loading="lazy" width="382" height="298" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="public/assets/images/gallery/gallery-5.png" alt="">
                        </li>
                        <li class="item" style="width:250px">
                        <img loading="lazy" width="382" height="298" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="public/assets/images/gallery/gallery-6.png" alt="">
                        </li>
                        <li class="item" style="width:250px">
                        <img loading="lazy" width="382" height="298" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="public/assets/images/gallery/gallery-7.png" alt="">
                        </li>
                        <li class="item" style="width:250px">
                        <img loading="lazy" width="382" height="298" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="public/assets/images/gallery/gallery-8.png" alt="">
                        </li>

                        <li class="item" style="width:250px">
                        <img loading="lazy" width="382" height="298" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="public/assets/images/gallery/gallery-9.png" alt="">
                        </li>
                        <li class="item" style="width:250px">
                        <img loading="lazy" width="382" height="298" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="public/assets/images/gallery/gallery-10.png" alt="">
                        </li>
                        <li class="item" style="width:250px">
                        <img loading="lazy" width="382" height="298" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="public/assets/images/gallery/gallery-11.png" alt="">
                        </li>
                        <li class="item" style="width:250px">
                        <img loading="lazy" width="382" height="298" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="public/assets/images/gallery/gallery-12.png" alt="">
                        </li>
                     </ul>
                  </div>
               </div>
...
<div class="container">
    ...
    <div class="testimonials-wrap">
        <div class="testmonial-cont">
            ...
            <div class="reviewer">
                <img class="user" width="70" height="72" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="public/assets/images/user-one.svg" alt="">
                <span>
                    Athithan
                    <img class="rating" width="100" height="15" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="public/assets/images/rating-four.svg" alt="">
                </span>
        ...
        <div class="testmonial-cont filled">
            ...
            <div class="reviewer">
                <img class="user" width="70" height="72" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="public/assets/images/user-two.svg" alt="">
                <span>
                Anukeerthana
                    <img class="rating" width="100" height="15" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="public/assets/images/rating-five.svg" alt="">
                </span>
        ...
        <div class="testmonial-cont">
            ...
            <div class="reviewer">
                <img class="user" width="70" height="72" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="public/assets/images/user-three.svg" alt="">
                <span>
                Sundar
                    <img class="rating" width="100" height="15" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" data-src="public/assets/images/rating-four.svg" alt="">
                </span>
...
<div class="container">
      ...
      <div class="publishd-date-wrap" itemscope="" itemtype="http://schema.org/WebPage"></span></div>
      </div>
      <!-- Last published date  -->
   <section>
      ...
      <div class="popup__content LoadImg" preload="none">
         ...
         <svg viewBox="0 0 384 512" style="display:block;height:18px;width:18px"><path d="M231.6 256l130.1-130.1c4.7-4.7 4.7-12.3 0-17l-22.6-22.6c-4.7-4.7-12.3-4.7-17 0L192 216.4 61.9 86.3c-4.7-4.7-12.3-4.7-17 0l-22.6 22.6c-4.7 4.7-4.7 12.3 0 17L152.4 256 22.3 386.1c-4.7 4.7-4.7 12.3 0 17l22.6 22.6c4.7 4.7 12.3 4.7 17 0L192 295.6l130.1 130.1c4.7 4.7 12.3 4.7 17 0l22.6-22.6c4.7-4.7 4.7-12.3 0-17L231.6 256z"></path></svg>
            ...
            <div class="popup-wrap">
                ...
                <img width="200" height="177" id="off" src="public/assets/images/offer.png" alt=""/>
                ...
                <img width="700" height="312"  id="popup-img" src="public/assets/images/popup-img.webp" alt=""/>
                </div>
...
</script><script src="public/assets/js/owl.carousel.min.js"></script>
