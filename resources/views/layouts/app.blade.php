...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/architects.css') }}" />
...
<body>
    ...
    {{-- <div class="body-container">
        <section class="section_container clearfix multifaceted">
            <div class="container">
                <div class="section-head">
                    <h2 class="section-title wow fadeInUp" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s;">Types of Residential Buildings Designed by Top Architects in Hosur</h2>
                    <h4 class="section-subtitle wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s;">A Good Architectural Company That Breathes Life Into Structures With Simplicity</h4>
                </div>
                <div class="gallery-wrapper hover">
                    <ul>
                        <li>
                            <img src="{{ asset('assets/images/gallery/residential-architects.png') }}" alt="Residential Architects in Hosur" title="Residential Architects in Hosur">
                        ...
                        <li>
                            <img src="{{ asset('assets/images/gallery/villa-architects.png') }}" alt="Villa Architects in Hosur" title="Villa Architects in Hosur">
                            <span>Villa</span>
                            <div class="hover-cont">
                                <h6>Villa</h6>
                                <p>Get your luxury villas planned by the best architects in hosur who are hand picked for their insightful designs.</p>
                            </div>
                        </li>
                        <li>
                            <img src="{{ asset('assets/images/gallery/apartment-architecture-design.png') }}" alt="Apartment Architectural Design Services" title="Apartment Architectural Design Services">
                            <span>Apartment</span>
                            <div class="hover-cont">
                                <h6>Apartment</h6>
                                <p>Locate your exclusive apartments sketched precisely with family-centric facilities to give the right sense of contentment.</p>
                            </div>
                        </li>
                        <li>
                            <img src="{{ asset('assets/images/gallery/bungalow-house-design.png') }}" alt="Bungalow House Plans" title="Bungalow House Plans">
                            <span>Bungalow</span>
                            <div class="hover-cont">
                                <h6>Bungalow</h6>
                                <p>Find your bungalow built to the highest standards with a perfect combination of modern architecture and features to provide comfort living.</p>
                            </div>
                        </li>
                        <li>
                            <img src="{{ asset('assets/images/gallery/duplex-architecture-design.png') }}" alt="Duplex Building Architecture Design" title="Duplex Building Architecture Design">
                            <span>Duplex House</span>
                            <div class="hover-cont">
                                <h6>Duplex House</h6>
                                <p>We have the best team of architects in hosur who deliver your extended lifespaces loaded with amenities, making your duplex house stand apart due to its distinct features.</p>
                            </div>
                        </li>
                        <li>
                            <img src="{{ asset('assets/images/gallery/row-house-architecture-design.png') }}" alt="Row House Design Plans" title="Row House Design Plans">
                            <span>Row House</span>
                            <div class="hover-cont">
                                <h6>Row House</h6>
                                <p>Enjoy living in the expansive space artfully designed to make an exclusive row house that you would be proud to own.</p>
                            </div>
                        </li>
                    </ul>
                </div>
            ...
            <div class="">
                <svg class="left rm768" xmlns="http://www.w3.org/2000/svg" width="395" height="280" viewBox="0 0 395 280">
                    <g id="Group_30200" data-name="Group 30200" transform="translate(4.748 -4876.405)">
                        ...
                        <path id="Rectangle_12652" data-name="Rectangle 12652" d="M0,0H194.5A13.5,13.5,0,0,1,208,13.5v0A13.5,13.5,0,0,1,194.5,27H0a0,0,0,0,1,0,0V0A0,0,0,0,1,0,0Z" transform="translate(-4.748 5129.405)" fill="white"></path>
                ...
                <svg class="right rm768" id="Group_30201" data-name="Group 30201" xmlns="http://www.w3.org/2000/svg" width="393" height="280" viewBox="0 0 393 280">
                    ...
                    <rect id="Rectangle_12651" data-name="Rectangle 12651" width="43" height="27" rx="13.5" transform="translate(0 164)" fill="white"></rect>
            ...
            <div class="container">
                ...
                <div class="tab-section clearfix">
                    ...
                    <div class="tab_container">
                        ...
                        <div id="tab1" class="tab_content clearfix" style="display: none;">
                            <div class="tab-img">
                                <img class=" lazy-img" src="{{ asset('assets/images/architects/floor-plan-architecture-design.png') }}" alt="House Floor Plan Designers" title="House Floor Plan Designers" style="">
                            </div>
                            <div class="tab-description wow fadeInUp animated" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s;">
                                ...
                                <a href="get-quote.php" class="button-link wow fadeInUp animated" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s;">
                                    Get a Quote
                                </a>
                            </div>
                        </div>
                        ...
                        <div id="tab2" class="tab_content clearfix" style="display: none;">
                            <div class="tab-img">
                                <img class=" lazy-img" src="{{ asset('assets/images/architects/structural-design-drawing.png') }}" alt="Structural Design Services" title="Structural Design Services">
                            </div>
                        ...
                        <div id="tab3" class="tab_content clearfix" style="display: none;">
                            <div class="tab-img">
                                <img class=" lazy-img" src="{{ asset('assets/images/architects/civil-plan-drawing.png') }}" alt="Civil Home Plan Drawing" title="Civil Home Plan Drawing">
                            </div>
                            <div class="tab-description">
                        ...
                        <div id="tab4" class="tab_content clearfix" style="display: none;">
                            <div class="tab-img">
                                <img class=" lazy-img" src="{{ asset('assets/images/architects/3d-elevation-designers.png') }}" alt="3d Elevation Designers in Hosur" style="">
                            </div>
                            <div class="tab-description">
                                <h3>3D Elevation</h3>
                                <p>The house's elevation provides a comprehensive 360-degree panoramic picture, demonstrating the physical accuracy of your home. We are the first home architects in hosur to offer this service, which allows consumers to see their home in 3D, making decision-making easier.Customers may visualise the interiors & exteriors with this approach.
                                </p>
                                <a href="get-quote.php" class="button-link wow fadeInUp animated" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s;">
                                    Get a Quote
                                </a>
                        ...
                        <div id="tab5" class="tab_content clearfix" style="display: none;">
                            <div class="tab-img">
                                <img class=" lazy-img" src="{{ asset('assets/images/architects/3d-interior-design-plan.png') }}" alt="3d Interior Designing Company" title="3d Interior Designing Company">
                            </div>
                            <div class="tab-description">
        ...
        <section class="section_container clearfix our-process">
                    ...
                    <div class="procrss-cont">
                        ...
                        <svg class="icons" xmlns="http://www.w3.org/2000/svg" width="52.66" height="47.996" viewBox="0 0 52.66 47.996">
                            ...
                            <g class="aqo" transform="translate(0 -22.677)">
                                ...
                                <path class="bqo" d="M252.375,97.255H233.783a1.029,1.029,0,0,0,0,2.057h18.592a1.029,1.029,0,1,0,0-2.057Z" transform="translate(-208.815 -66.907)"/>
                            </g>
                        </svg>
                    </div>
                    <div class="procrss-cont">
                        ...
                        <svg class="icons" xmlns="http://www.w3.org/2000/svg" width="37.497" height="47.996" viewBox="0 0 37.497 47.996">
                            <defs>
                                <style>.aro{opacity:0.5;}.bro{fill:#1a232c;}</style>
                            </defs>
                            <g class="aro" transform="translate(-56)">
                                <path class="bro" d="M118.266,156.864l4.383-5.272a.7.7,0,0,0-1.081-.9l-3.757,4.519-.821-1.334a.7.7,0,0,0-1.2.737l1.335,2.168A.7.7,0,0,0,118.266,156.864Z" transform="translate(-54.093 -136.337)"/>
                                <path class="bro" d="M115.794,253.614l1.335,2.168a.7.7,0,0,0,1.139.081l4.383-5.272a.7.7,0,0,0-1.081-.9l-3.757,4.519-.821-1.334a.7.7,0,1,0-1.2.737Z" transform="translate(-54.094 -226.055)"/>
                                <path class="bro" d="M115.794,353.281l1.335,2.168a.7.7,0,0,0,1.139.081l4.383-5.272a.7.7,0,1,0-1.081-.9l-3.757,4.519-.821-1.334a.7.7,0,1,0-1.2.737Z" transform="translate(-54.094 -316.379)"/>
                                <path class="bro" d="M92.794,175a.7.7,0,0,0-.7.7v5.118a1.079,1.079,0,0,1-1.078,1.078H58.484a1.079,1.079,0,0,1-1.078-1.078V150.012a.7.7,0,0,0-1.406,0v30.812a2.487,2.487,0,0,0,2.484,2.484H91.013a2.487,2.487,0,0,0,2.484-2.484v-5.118A.7.7,0,0,0,92.794,175Z" transform="translate(0 -135.312)"/>
                                <path class="bro" d="M91.013,5.417H87.574V2.512a2.512,2.512,0,0,0-5.025,0V5.417H77.261V2.512a2.512,2.512,0,0,0-5.025,0V5.417H66.948V2.512a2.512,2.512,0,1,0-5.025,0V5.417H58.484A2.487,2.487,0,0,0,56,7.9v3.517a.7.7,0,1,0,1.406,0V7.9a1.079,1.079,0,0,1,1.078-1.078h3.439V7.94a2.512,2.512,0,1,0,5.025,0V6.824h5.288V7.94a2.512,2.512,0,0,0,5.025,0V6.824h5.288V7.94a2.512,2.512,0,1,0,5.025,0V6.824h3.439A1.079,1.079,0,0,1,92.091,7.9V37.113a.7.7,0,0,0,1.406,0V7.9a2.487,2.487,0,0,0-2.484-2.484ZM65.542,7.94a1.106,1.106,0,0,1-2.212,0V2.512a1.106,1.106,0,0,1,2.212,0Zm10.313,0a1.106,1.106,0,1,1-2.212,0V2.512a1.106,1.106,0,1,1,2.212,0Zm10.313,0a1.106,1.106,0,0,1-2.212,0V2.512a1.106,1.106,0,0,1,2.212,0Z" transform="translate(0)"/>
                                <path class="bro" d="M200.442,182.589h14.811a2.2,2.2,0,1,0,0-4.406H200.442a2.2,2.2,0,0,0,0,4.406Zm0-3h14.811a.8.8,0,1,1,0,1.594H200.442a.8.8,0,1,1,0-1.594Z" transform="translate(-128.905 -161.48)"/>
                                <path class="bro" d="M200.442,281.8h14.811a2.2,2.2,0,1,0,0-4.406H200.442a2.2,2.2,0,0,0,0,4.406Zm0-3h14.811a.8.8,0,0,1,0,1.594H200.442a.8.8,0,0,1,0-1.594Z" transform="translate(-128.905 -251.392)"/>
                                <path class="bro" d="M200.442,381.014h14.811a2.2,2.2,0,1,0,0-4.406H200.442a2.2,2.2,0,0,0,0,4.406Zm0-3h14.811a.8.8,0,1,1,0,1.594H200.442a.8.8,0,1,1,0-1.594Z" transform="translate(-128.905 -341.304)"/>
                            </g>
                        </svg>
                    </div>
                    <div class="procrss-cont">
            ...
            <svg class="patterns" xmlns="http://www.w3.org/2000/svg" width="303.477" height="455.412" viewBox="0 0 303.477 455.412">
                <defs>
                    <style>.wqa{opacity:0.15;}.wqb{fill:white;}</style>
                </defs>
                <g class="wqa" transform="translate(303.477) rotate(90)">
                    <path class="wqb" d="M227.71,303.477C102.152,303.477,0,201.334,0,75.775A226.5,226.5,0,0,1,12.973,0H82.43a162.861,162.861,0,0,0-18.6,75.775c0,90.363,73.513,163.877,163.876,163.877S391.587,166.139,391.587,75.775A162.848,162.848,0,0,0,372.991,0h69.448a226.5,226.5,0,0,1,12.973,75.775C455.412,201.334,353.27,303.477,227.71,303.477Z"/>
                </g>
            </svg>
        </section>
        <section class="section_container clearfix multifaceted">
                    ...
                    <div id="upload-content1" class="active target-div">
                        <ul class="owl-carousel">
                            <li class="item" style="width:250px">
                                <img loading="lazy" src="{{ asset('assets/images/gallery/gallery-1.png') }}" alt="">
                            </li>
                            <li class="item" style="width:250px">
                                <img loading="lazy" src="{{ asset('assets/images/gallery/gallery-2.png') }}" alt="">
                            </li>
                            <li class="item" style="width:250px">
                                <img loading="lazy" src="{{ asset('assets/images/gallery/gallery-3.png') }}" alt="">
                            </li>
                            <li class="item" style="width:250px">
                                <img loading="lazy" src="{{ asset('assets/images/gallery/gallery-4.png') }}" alt="">
                            </li>
                            <li class="item" style="width:250px">
                                <img loading="lazy" src="{{ asset('assets/images/gallery/gallery-5.png') }}" alt="">
                            </li>
                            <li class="item" style="width:250px">
                                <img loading="lazy" src="{{ asset('assets/images/gallery/gallery-6.png') }}" alt="">
                            </li>
                            <li class="item" style="width:250px">
                                <img loading="lazy" src="{{ asset('assets/images/gallery/gallery-7.png') }}" alt="">
                            </li>
                            <li class="item" style="width:250px">
                                <img loading="lazy" src="{{ asset('assets/images/gallery/gallery-8.png') }}" alt="">
                            </li>
                            <li class="item" style="width:250px">
                                <img loading="lazy" src="{{ asset('assets/images/gallery/gallery-9.png') }}" alt="">
                            </li>
                            <li class="item" style="width:250px">
                                <img loading="lazy" src="{{ asset('assets/images/gallery/gallery-10.png') }}" alt="">
                            </li>
                            <li class="item" style="width:250px">
                                <img loading="lazy" src="{{ asset('assets/images/gallery/gallery-11.png') }}" alt="">
                            </li>
                            <li class="item" style="width:250px">
                                <img loading="lazy" src="{{ asset('assets/images/gallery/gallery-12.png') }}" alt="">
                            </li>
                            <li class="item" style="width:250px">
                                <img loading="lazy" src="{{ asset('assets/images/gallery/gallery-13.png') }}" alt="">
                            </li>
                            <li class="item" style="width:250px">
                                <img loading="lazy" src="{{ asset('assets/images/gallery/gallery-14.png') }}" alt="">
                            </li>
                        </ul>
                    </div>
                </div>
