...
<section class="section_container middle-cta">
    <div class="">
        ...
        <div class="mid-cta">
                ...
                {{-- <a href="{{ route('get.quote') }}" type="button" class="action_buttons" id="experts">Get A Free Quote</a> --}}
          ...
          <div class="tab_container">
             ...
             <div id="tab2" class="tab_content clearfix" style="display: none;">
                ...
                <div class="tab-description">
                   ...
                   <p>Top architects take pride in providing your planned home with the structural drawings you specify, sticking to foundation, size, &amp; framing details to the letter. Collaborate with {{ $settings->app_name }} skilled designers in Allahabaad to produce a structure that will withstand the load for years, giving you the dream home you've always desired.
                   </p>
             ...
             <div id="tab4" class="tab_content clearfix" style="display: none;">
                <div class="tab-img">
                <img class=" lazy-img" src="public/assets/images/architects/3d-elevation-designers.png" alt="3d Elevation Designers in Allahabaad" style="">
    ...
    <div class="container">
        ...
        <div class="testimonials-wrap">
            ...
            <div class="testmonial-cont filled">
                <p>In every way, {{ $settings->app_name }} Architects and Construction expert’s performance has been amazing. When it comes to material purchases for construction, we appreciate your expertise and attention to our needs, thereby saving us millions! </p>
                <div class="reviewer">
            ...
            <div class="testmonial-cont">
                <p>My family and I couldn't dream of a residence which is so prettily designed. The vibe is & our housing project has the right architecture designed making it so rejuvenating and beautiful. Finally, we enjoy living our dream! Thanks to {{ $settings->app_name }} Architects & Construction.</p>
                <div class="reviewer">
