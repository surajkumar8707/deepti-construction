            ...
            <div class="banner-content banner-left animate">
                <div class="banner-title">
                    <h1 class="section-title wow fadeInUp" style="visibility: visible;">
                        ...
                        <span class="banner-text wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s;">Get a House Construction Service For Residential Buildings Within Your Budget in Bangalore With Quality, Transparency, Timely Completion and Warranty.</span>
                    </h1>
                </div>
