            ...
            <div class="banner-content banner-left animate">
                <div class="banner-title">
                    <h1 class="section-title wow fadeInUp" style="visibility: visible;">
                        ...
                        <p>Unlock Your Designs With</p>
                        Best Interior Designers in Bangalore
                        <span class="banner-text wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s;">Get Personalised Designs For Your Home Interiors & Exteriors in Today's Lifestyle Within Your Budget</span>
                    </h1>
                </div>
