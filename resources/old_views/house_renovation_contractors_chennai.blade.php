            ...
            <div class="banner-content banner-left animate">
                <div class="banner-title">
                    <h1 class="section-title wow fadeInUp" style="visibility: visible;">
                        ...
                        <p>A Professional & Reliable</p>
                        Renovation Contractors In Chennai
                        <span class="banner-text wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s;">Get an End-to-End House Remodeling Services Including Civil Renovation, Floor Addition, Kitchen, Living Room & Bedrooms Within Your Budget.</span>
                    </h1>
                </div>
